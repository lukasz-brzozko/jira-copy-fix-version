...
(function () {
  ...
  var showMessage = function showMessage() {
    var info = document.querySelector(SELECTORS.infoMessage);
    info.classList.remove("active");
    void info.offsetWidth; // force reflow
    info.classList.add("active");
  };
  var copyLinkIntoClipboard = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(link) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            textOnly = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
            clipboardItem = createClipBoardItem(link, textOnly);
            _context2.next = 4;
    ...
    return function copyLinkIntoClipboard(_x) {
      return _ref3.apply(this, arguments);
    };
  }();
  var handleContextMenu = function handleContextMenu(e) {
    var target = e.target;
    var isStandardFixVersion = target.closest(SELECTORS.linkContainer);
    var isTableFixVersion = target.closest(SELECTORS.versionTableContainer);
    var isFixVersion = isStandardFixVersion || isTableFixVersion;
